...
import { ResetAudioCallQueue } from "../redux/audioCall";
...
const CallDialog = ({ sender, children }) => {
  ...
  const appID = 336023927;
  const server = "wss://webliveroom336023927-api.coolzcloud.com/ws";
  ...
  const handleDisconnect = (event, reason) => {
    if (reason && reason === "backdropClick") {
      ...
      // handle Call Disconnection => this will be handled as cleanup when this Modal unmounts

      // at the end call handleClose Modal
      onClose();
    }
  };
